...
int Omok_Board[20][20] = { NULL, };								// 게임 시작전 오목판을 초기화하는 전역변수 
...
int Check_6(int x, int y)
{
	...
	// 반대 대각선체크. 
	if ((Omok_Board[y - 4][x / 2 + 4] == 2 && Omok_Board[y - 3][x / 2 + 3] == 0 && Omok_Board[y - 2][x / 2 + 2] == 2 && Omok_Board[y - 1][x / 2 + 1] == 2 && Omok_Board[y + 1][x / 2 - 1] == 0) ||
		(Omok_Board[y - 3][x / 2 + 3] == 2 && Omok_Board[y - 2][x / 2 + 2] == 2 && Omok_Board[y - 1][x / 2 + 1] == 2 && Omok_Board[y + 1][x / 2 - 1] == 2 && Omok_Board[y + 2][x / 2 - 2] == 2) ||
		(Omok_Board[y - 2][x / 2 + 2] == 2 && Omok_Board[y - 1][x / 2 + 1] == 2 && Omok_Board[y + 1][x / 2 - 1] == 2 && Omok_Board[y + 2][x / 2 - 2] == 2 && Omok_Board[y + 3][x / 2 - 3] == 2) ||
		(Omok_Board[y - 1][x / 2 + 1] == 2 && Omok_Board[y + 1][x / 2 - 1] == 2 && Omok_Board[y + 2][x / 2 - 2] == 2 && Omok_Board[y + 3][x / 2 - 3] == 2 && Omok_Board[y + 4][x / 2 - 4] == 2)
		)
...
int adviceDefense(int x, int y)
{
	int count = 0;

	if ( //가로공격
		/*(Omok_Board[y][x / 2 - 1] == 0 && Omok_Board[y][x / 2] == 2 && Omok_Board[y][x / 2 + 1] == 2 && Omok_Board[y][x / 2 + 2] == 2 && Omok_Board[y][x / 2 + 3] == 0 && Omok_Board[y][x / 2 + 4] == 0) ||
		(Omok_Board[y][x / 2 - 1] == 0 && Omok_Board[y][x / 2] == 2 && Omok_Board[y][x / 2 + 1] == 2 && Omok_Board[y][x / 2 + 2] == 0 && Omok_Board[y][x / 2 + 3] == 2 && Omok_Board[y][x / 2 + 4] == 0) ||
		
		(Omok_Board[y][x / 2 - 1] == 0 && Omok_Board[y][x / 2] == 2 && Omok_Board[y][x / 2 + 1] == 2 && Omok_Board[y][x / 2 + 2] == 0 && Omok_Board[y][x / 2 + 3] == 2 && Omok_Board[y][x / 2 + 4] == 0) ||
		(Omok_Board[y][x / 2 - 2] == 0 && Omok_Board[y][x / 2 - 1] == 2 && Omok_Board[y][x / 2] == 2 && Omok_Board[y][x / 2 + 1] == 2 && Omok_Board[y][x / 2 + 2] == 0 && Omok_Board[y][x / 2 + 3] == 0) ||
		(Omok_Board[y][x / 2 - 3] == 0 && Omok_Board[y][x / 2 - 2] == 2 && Omok_Board[y][x / 2 - 1] == 2 && Omok_Board[y][x / 2] == 2 && Omok_Board[y][x / 2 + 1] == 0 && Omok_Board[y][x / 2 + 2] == 0) ||

		(Omok_Board[y][x / 2 - 2] == 0 && Omok_Board[y][x / 2 - 1] == 0 && Omok_Board[y][x / 2] == 2 && Omok_Board[y][x / 2 + 1] == 2 && Omok_Board[y][x / 2 + 2] == 2 && Omok_Board[y][x / 2 + 3] == 0) ||
		(Omok_Board[y][x / 2 - 3] == 0 && Omok_Board[y][x / 2 - 2] == 0 && Omok_Board[y][x / 2 - 1] == 2 && Omok_Board[y][x / 2] == 2 && Omok_Board[y][x / 2 + 1] == 2 && Omok_Board[y][x / 2 + 2] == 0) ||
		(Omok_Board[y][x / 2 - 4] == 0 && Omok_Board[y][x / 2 - 3] == 0 && Omok_Board[y][x / 2 - 2] == 2 && Omok_Board[y][x / 2 - 1] == 2 && Omok_Board[y][x / 2] == 2 && Omok_Board[y][x / 2 + 1] == 0) ||
		...
		(Omok_Board[y][x / 2 - 1] ==  0&& Omok_Board[y][x / 2] ==  2&& Omok_Board[y][x / 2 + 1] ==  2&& Omok_Board[y][x / 2 + 2] ==  2&& Omok_Board[y][x / 2 + 3] == 0 && Omok_Board[y][x / 2 + 4] == 0) ||
		(Omok_Board[y][x / 2 - 2] ==  0&& Omok_Board[y][x / 2-1] ==  2&& Omok_Board[y][x / 2 ] ==  2&& Omok_Board[y][x / 2 + 1] ==  2&& Omok_Board[y][x / 2 + 2] == 0 && Omok_Board[y][x / 2 + 3] == 0) ||
		(Omok_Board[y][x / 2 - 3] ==  0&& Omok_Board[y][x / 2-2] ==  2&& Omok_Board[y][x / 2 -1] ==  2&& Omok_Board[y][x / 2 + 0] ==  2&& Omok_Board[y][x / 2 + 1] == 0 && Omok_Board[y][x / 2 + 2] == 0) ||

		(Omok_Board[y][x / 2 - 2] ==  0&& Omok_Board[y][x / 2-1] ==  0&& Omok_Board[y][x / 2 ] ==  2&& Omok_Board[y][x / 2 + 1] ==  2&& Omok_Board[y][x / 2 + 2] == 2 && Omok_Board[y][x / 2 + 3] == 0) ||
		(Omok_Board[y][x / 2 - 3] ==  0&& Omok_Board[y][x / 2-2] ==  0&& Omok_Board[y][x / 2 -1] ==  2&& Omok_Board[y][x / 2 ] ==  2&& Omok_Board[y][x / 2 + 2] == 2 && Omok_Board[y][x / 2 + 3] == 0) ||
